...
class Annotations {
    ...
    renderAnnotationElements() {
        ...
        this.gauge.annotations.map((annotation, index) => {
            if (annotation.content !== null) {
                this.createAnnotationTemplate(annotationGroup, index, annotationGroup, secondaryID);
            }
        });
    }
    /**
     ...
     */
    //tslint:disable
    createAnnotationTemplate(element, annotationIndex, annotationGroup, secondaryID) {
        let left;
        let top;
        let templateFn;
        ...
        let annotationRenderSuccess = (argsData) => {
            if (!argsData.cancel) {
                let blazor = 'Blazor';
                ...
                if (!(isNullOrUndefined(argsData.annotation.axisValue))) {
                    ...
                    if (this.gauge.orientation === 'Vertical') {
                        ...
                        top = ((valueToCoefficient(argsData.annotation.axisValue, axis, this.gauge.orientation, range) * line.height) + line.y);
                        top += argsData.annotation.y;
                    }
                    else {
                        left = ((valueToCoefficient(argsData.annotation.axisValue, axis, this.gauge.orientation, range) * line.width) + line.x);

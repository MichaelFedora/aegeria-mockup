    ...
    GanttTreeGrid.prototype.createTreeGridColumn = function (column, isDefined) {
        ...
        if (taskSettings.id === column.field) {
            ...
            if (isBlazor() && !column.template) {
                this.parent.showInlineNotes = true;
            }
...
var EventMarker$1 = /** @class */ (function () {
